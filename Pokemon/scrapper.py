...
# client = MongoClient(MONGO_DB_CLIENT_URL)
# db = client.Projet_perso
...
for pokemon in pokemon_rows[0:100]:
    ...
    mydict = {
            ...
            "details_url": typed_pokemon.details_url,
    ...
    # scraped_count += 1
    # print(f'{name}, scraped so far: {scraped_count}')
    # print(name)
# print("----------------------------------------DONE--------------------------------------------")
